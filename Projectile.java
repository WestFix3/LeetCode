...
import physics.Rectangle; // Szükséges a Rectangle osztály eléréséhez
...
public class Projectile extends Entity {
    ...
    // --- VÁLTOZÁS ITT: a damage típusa int-ről float-ra változik ---
    private int id;
    ...
    // A konstruktorban is float-ra kell módosítani a damage paramétert
    ...
    public void render() {
        ...
        // Lövedék rajzolása (egyszerű sárga négyzetként)
    ...
    // A getter is float-ot ad vissza
